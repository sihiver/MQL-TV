...
val AppSettingsSaver = listSaver<AppSettings, Any>(
    save = { s ->
        listOf(
            ...
            s.m3uUrl, s.epgUrl, s.autoRefresh, s.refreshInterval, s.userAgent,
    ...
    restore = { v ->
        AppSettings(
            ...
            deviceName = v[24] as String,
            maxDevices = v[25] as Int,
            darkMode = v[26] as Boolean,
            language = v[27] as String,
            clockFormat = v[28] as String,
            autoplay = v[29] as Boolean,
            rememberPosition = v[30] as Boolean,
        )
    },
)
